<template>
   <div class="container"> 
    <Header></Header>
    <form class="row g-3 mt-5" @submit.prevent="crear">
        <div class="col">
            ...
            <div class="form-floating">
                <textarea class="form-control" id="floatingTextarea2" v-model="descripcion" style="height: 100px"></textarea>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12" style="height:15rem;width:15rem; object-fit: cover; ">
                    <div class="hovereffect">
                        <img class="card-img-top" v-bind:src="imgProducto" alt="" style="height:15rem;width:15rem; object-fit: cover;">
                        <div class="overlay" v-on:click="openUpload('file-field')">
                            <h2>Seleccionar Imagen</h2>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12" style="width:15rem; object-fit: cover;">
                    <div class="hovereffect">
                        <img class="card-img-top" v-bind:src="imgBanner" alt="" style="max-height:15rem;width:15rem; object-fit: cover;">
...
export default {
    ...
    methods:{
        ...
        updatePreviewPrincipal (e) {
            ...
            reader.onload = (e) => {
            this.imgProducto = e.target.result
            }
        ...
        updatePreviewBanner (e) {
            ...
            reader = new FileReader();
            reader.onload = (e) => {
            this.imgBanner = e.target.result
            }
            reader.readAsDataURL(files[0])}
        },
        async crear(){
            ...
            if(token != ''){
                ...
                await this.axios.post(`/api/productos`,fd,config).then(response=>{
