        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _this.axios.post('/api/auth/login', {
                  email: _this.email,
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 3;
                return _this2.axios.post('/api/auth/me', {}, config).then(function (response) {
                  if (response.data.rol == 'SUPERADMIN') {
                    localStorage.setItem('token', JSON.stringify(data));
                    console.log('Ta piola' + JSON.parse(localStorage.getItem('token')).token);
...
var render = function () {
  ...
  return _c("div", { staticClass: "container-fluid bg-primary" }, [
    _c("div", { staticClass: "row align-items-stretch" }, [
      _c("div", {
        staticClass:
          "col bg d-none d-lg-block col-lg-8 col-md-6 col-sm-4 col-2",
      }),
      _vm._v(" "),
      _c(
        "div",
        {
          staticClass: "col bg-white p-5",
          staticStyle: { width: "25%", height: "100vh" },
        },
        [
          _vm._m(0),
          _vm._v(" "),
          _c("h2", { staticClass: "fw-bold text-left py-5" }, [
            _vm._v("Bienvenido a Don-Nut"),
          ]),
          _vm._v(" "),
          _c(
            "form",
                  ...
                  directives: [
                    {
                      name: "model",
                      rawName: "v-model",
                      value: _vm.recordarme,
                      expression: "recordarme",
                    },
                  ],
                  staticClass: "form-check-input",
                  attrs: { type: "checkbox", name: "connected" },
                  domProps: {
                    checked: Array.isArray(_vm.recordarme)
                      ? _vm._i(_vm.recordarme, null) > -1
                      : _vm.recordarme,
                  },
                  on: {
                    change: function ($event) {
                      var $$a = _vm.recordarme,
                        $$el = $event.target,
